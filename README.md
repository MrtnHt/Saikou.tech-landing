<p align="center">
  <img src="Saikou.tech-logo-flat-hor.svg" alt="Saikou Tech Logo" width="250">
</p>
...
2. **ASC Engine (Layer 02):** Adversarial Self-Critique. An internal adversarial process attacks the response for factual errors or contradictions.
3. **Zero-Guessing Gateway (Layer 03):** The final determinism lock. If absolute certainty is not reached, the output is intercepted and converted into a Diagnostic Roadmap.

---

## ⚙️ Requirements & Installation

This API is built for speed and reliability using FastAPI and the Google Gemini Engine.
